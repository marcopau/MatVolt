function H = Jacobian_Iir_Irx(branch, bus, type)
...
%
% SYNTAX:
%   H = Jacobian_Iir_Irx(branch, bus, type)
%
% INPUTS: 
...
%
% OUTPUTS:
%   H : Jacobian matrix of real current injections for rectangular branch
...
for i = 1:nmeas
    ...
    HIr(i,from) = 1;                    % derivative dIr/dIr
    HIr(i,to) = - 1;                    % derivative -dIr/dIr
end
